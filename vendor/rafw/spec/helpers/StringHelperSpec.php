...
class DescribeStringHelper extends PHPSpec_Context
{
	public function itShouldAbleToTestIfAStringStartsWithAnotherString()
	{
		...
		$this->spec(Ra_StringHelper::starts_with($haystack, "This"))->should->beTrue();
		$this->spec(Ra_StringHelper::starts_with($haystack, "not"))->should->beFalse();
		$this->spec(Ra_StringHelper::starts_with($haystack, "this"))->should->beFalse();
	}
	...
	public function itShouldAbleToTestIfAStringEndsWithAnotherString()
	{
		...
		$this->spec(Ra_StringHelper::ends_with($haystack, "string"))->should->beTrue();
		$this->spec(Ra_StringHelper::ends_with($haystack, "not"))->should->beFalse();
		$this->spec(Ra_StringHelper::ends_with($haystack, "String"))->should->beFalse();
	}
	...
	public function itShouldTruncateAString()
	{
		...
		$truncated = Ra_StringHelper::truncate($string, 30);
	...
	{
		$string = "My string is getting to long for the text where I want to use it.";
		$truncated = Ra_StringHelper::truncate($string, 30, true);
