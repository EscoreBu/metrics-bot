...
define("RA_ZIP_FILE", 1);
define("RA_ZIP_DIRECTORY", 2);
...
class Ra_Zip
{
	...
	{
		if (!is_file($path)) {
			throw new Ra_Zip_Exception("The file $path doesn't exists");
		}
...
class Ra_Zip_Exception extends Exception {}
